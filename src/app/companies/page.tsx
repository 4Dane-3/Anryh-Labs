...
const companies = [
  {
    ...
    name: "ClyncAllo",
    description:
      "Clync is a local-first AI desktop app that cleans, classifies, and fixes documents before they hit your local file system.\n\nClync-Allo Enterprise provides cloud and CRM organization, helping eliminate digital clutter and improve file efficiency.",
    status: "Active",
    href: "https://clync.me",
    logo: "/clync-logo.png",
    external: true,
  },
  {
    ...
    name: "ClyncGeo",
    description:
      "ClyncGEO is a Property Management Generative Engine Optimization company; consulting and injecting portfolio properties in AI search engines like Google Gemini, ChatGPT, Claude, Perplexity, and more.",
    status: "Pending",
    logo: "/favicon.svg",
    external: false,
  },
        ...
        <div className="mx-auto max-w-[1336px] px-6 py-16">
          ...
          >
            ...
            <p className="text-[21px] text-white/70 max-w-2xl">
              Ventures built under Anryh Labs. Human-first technologies designed
              to serve people.
            </p>
          </motion.div>
          ...
          >
            <p className="text-white/40 text-sm">
              More ventures coming soon. Building human-first technologies, one
              company at a time.
            </p>
          </motion.div>
        </div>
